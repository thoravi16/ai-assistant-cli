...
from ai_cli.ai_engine import ask_ai, summarize_text, explain_code, generate_command, generate_code
...
def dev():
    ...
    while True:
        ...
        user_input = console.input("dev> ")

        if user_input.lower() in ["exit", "quit"]:
            console.print("Exiting developer mode...")
            break
